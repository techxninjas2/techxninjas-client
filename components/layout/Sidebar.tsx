...
const SidebarNavItem: React.FC<{
  ...
  <NavLink
    ...
    onMouseEnter={
      !isExpanded && onMouseEnter ? (e) => onMouseEnter(e, title) : undefined
    }
    ...
    className={`flex items-center px-3 py-2 rounded-lg text-sm font-medium
              ...
              hover:text-gray-800 hover:shadow-[0_0_15px_rgba(255,165,0,0.5)] 
              dark:hover:shadow-[0_0_15px_rgba(255,215,0,0.5)]
...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const isEffectivelyOpen =
    sidebarState === "hover-expanded" || sidebarState === "pinned-expanded";
        ...
        return (
          <div className="relative w-full" ref={userDropdownRef}>
            ...
            {isUserDropdownOpen && (
              ...
              >
                <span
                  className="block px-4 py-2 text-xs text-gray-500 dark:text-gray-400 truncate"
                  role="none"
                >
                  {user.email}
                </span>
                ...
                <Link
                  ...
                  role="menuitem"
                >
                  <YoutubeIcon className="w-4 h-4 mr-2 lucide" /> Creator
                  Dashboard
                </Link>
                <button
      ...
      >
        <div
          className={`flex items-center mb-6 ${
            isEffectivelyOpen ? "px-4 justify-between" : "px-0 justify-center"
          }`}
        >
          {isEffectivelyOpen && (
        ...
        >
          <div
            className={`flex ${
              isEffectivelyOpen
                ...
                : "flex-col space-y-3 items-center"
            } mb-3 w-full`}
          >
            <ThemeToggle />
            <button
          ...
          <div
            className={`${
              isEffectivelyOpen ? "" : "flex flex-col items-center"
            }`}
          >
        ...
        <button
          ...
          aria-label={
            sidebarState === "pinned-expanded"
              ? "Collapse and unpin sidebar"
              : "Expand and pin sidebar"
          }
        >
          {sidebarState === "pinned-expanded" ? (
