...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative bg-brand-gray-300 dark:bg-brand-dark-gray text-white py-20 md:py-32 overflow-hidden border-b-2 dark:border-green-300 border-gray-400">
      <CodingBackground
        intensity="medium"
        style="matrix"
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <RevealOnScroll direction="down" duration={1000}>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-gray-700 dark:text-brand-ninja-gold">
            Welcome to TechXNinjas
          </h1>
        </RevealOnScroll>

        <RevealOnScroll direction="up" delay={300} duration={1000}>
          <p className="text-lg md:text-xl text-gray-500 dark:text-brand-off-white mb-8 max-w-3xl mx-auto">
            Your ultimate platform for hackathons, tech challenges, community
            interaction, and professional growth in the world of technology.
          </p>
        </RevealOnScroll>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10">
          {highlights.map((highlight, index) => (
            <RevealOnScroll
              ...
              duration={800}
            >
              <div className="flex items-center bg-white/20 backdrop-blur-sm text-gray-500 dark:text-brand-ninja-gold rounded-full shadow-md text-xs md:text-sm py-1 md:py-2 px-3 md:px-4">
        ...
        <RevealOnScroll direction="up" delay={800} duration={1000}>
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            >
              <MessageSquare className="w-5 h-5 mr-2" /> Join our WhatsApp
              Community
            </a>
          </div>
        </RevealOnScroll>
...
const OurJourneySection: React.FC = () => {
  const journeyPoints = [
    {
      emoji: "🤯",
      title: "The Maze of Choices",
      text: "Lost in the sea of tech options, unsure where to begin.",
    },
    {
      emoji: "💡",
    ...
    {
      emoji: "🤝",
      title: "Helping Hand Extended",
      text: "Started sharing knowledge, one student at a time.",
    },
    {
      emoji: "🚀",
      title: "Community Takes Flight",
      text: "From a small group to a thriving, supportive network.",
    },
  ];
  return (
...
const WhyTechXNinjasSection: React.FC = () => {
  const struggles = [
    {
      text: "Heard about Hackathons when I saw winner's Post on LinkedIn 😕",
      emoji: "😕",
    },
    { text: '"Where do I start? DSA or Web Dev or ML?" 😵‍💫', emoji: "😵‍💫" },
    {
      text: '"I feel left behind. Everyone is doing something…" 😔',
      emoji: "😔",
    },
