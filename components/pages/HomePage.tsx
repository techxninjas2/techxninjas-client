...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-screen max-h-[900px] bg-gray-900 overflow-hidden">
      {/* Background container with proper overflow control */}
      <div className="absolute inset-0 overflow-hidden">
        <CodingBackground intensity="medium" style="matrix" className="w-full h-full object-cover" />
      </div>

      {/* Content container with proper z-index and padding */}
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        <RevealOnScroll direction="up" delay={300} duration={1000}>
          <p className="text-lg md:text-xl text-gray-300 dark:text-gray-200 mb-8 max-w-3xl mx-auto">
            Your ultimate platform for hackathons, tech challenges, community interaction, and professional growth in
        ...
        <RevealOnScroll direction="up" delay={800} duration={1000}>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <Link
              to="/events"
              className="bg-brand-primary hover:bg-brand-primary/80 text-white font-semibold py-3 px-8 rounded-lg shadow-lg transition-all duration-300 text-lg hover:scale-105">
              Start Exploring
            </Link>
            <Link
              to="/courses"
              className="bg-brand-light-blue hover:bg-brand-light-blue/80 text-white font-semibold py-3 px-8 rounded-lg shadow-lg transition-all duration-300 text-lg hover:scale-105">
              Browse Programs
            </Link>
            <a
              ...
              className="bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-8 rounded-lg shadow-lg transition-all duration-300 text-lg inline-flex items-center hover:scale-105">
...
const CommunityStatsSection: React.FC = () => {
  ...
  return (
    <section className="relative py-16 bg-brand-off-white dark:bg-brand-dark-gray overflow-hidden">
      <CodingBackground intensity="low" style="binary" className="absolute inset-0 z-0" />
            ...
            <RevealOnScroll key={index} direction="up" delay={300 + index * 150} duration={800}>
              <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300 backdrop-blur-sm bg-opacity-90 dark:bg-opacity-90">
                ...
                <p className={`text-4xl font-extrabold ${stat.color} mb-2`}>
                  <AnimatedCounter end={stat.value} duration={2000} delay={500 + index * 200} />
                </p>
...
const OurJourneySection: React.FC = () => {
  const journeyPoints = [
    ...
    {
      emoji: "💡",
      title: "A Spark of Clarity",
      text: "Realized true need: not just content, but guidance and community.",
    },
  ...
  return (
    <section className="relative py-16 bg-white dark:bg-gray-800 overflow-hidden">
      <CodingBackground intensity="low" style="code" className="absolute inset-0 z-0" />
      <div className="container mx-auto px-4 relative z-10">
        <RevealOnScroll direction="up" duration={800}>
          <h2 className="text-3xl font-bold text-center mb-12 text-brand-dark-gray dark:text-white">
            From One Student's Struggle… <br className="sm:hidden" />
            to a Movement of Thousands.
          </h2>
        </RevealOnScroll>
            ...
            {journeyPoints.map((point, index) => (
              <RevealOnScroll key={index} direction="up" delay={300 + index * 150} duration={800}>
                <div className="relative bg-brand-off-white dark:bg-brand-dark-gray p-6 rounded-xl shadow-lg border-l-4 border-brand-primary dark:border-brand-ninja-gold backdrop-blur-sm bg-opacity-90 dark:bg-opacity-90">
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-brand-primary dark:text-brand-ninja-gold">
                    {point.title}
                  </h3>
        ...
        <RevealOnScroll direction="up" delay={900} duration={800}>
          <div className="text-center mt-12 text-gray-600 dark:text-gray-400">
            <p className="text-lg font-semibold">
              2024 <ArrowRight className="inline w-5 h-5 mx-1" /> Present
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start">
          <div>
            <RevealOnScroll direction="left" duration={800}>
              <h3 className="text-2xl font-semibold mb-6 text-brand-primary dark:text-brand-ninja-gold text-center md:text-left">
